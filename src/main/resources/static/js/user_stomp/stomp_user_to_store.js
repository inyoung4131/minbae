...
// let userIdx = memberData.memberData.userIdx;
// console.log('console.log(userIdx) -> ' + userIdx)

// let shoppingList = JSON.parse(sessionStorage.getItem('item'));
// let storeIdx = shoppingList[0][0];
...
function sendName() {
    stompClient.send(`/app/store/1`, {}, JSON.stringify({'name': $("#name").val()}));
}
